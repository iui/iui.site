...
<html>
  ...
  <body>
    <a href="https://github.com/iui/iUI"><img style="position: absolute; z-index: 2000; top: 46px; right: 0; border: 0;" src="https://s3.amazonaws.com/github/ribbons/forkme_right_darkblue_121621.png" alt="Fork me on GitHub"></a>
    <div id="main">
      ...
      <p id="footer">
          iUI &copy; 2007-2015 - iUI is Open Source: MIT license - <a href="sitemap">Sitemap</a> - <g:link mapping="donate">Donate</g:link>
      </p>
    </div>
  </body>
</html>
